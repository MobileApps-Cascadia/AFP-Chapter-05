...
public class ColorDialogFrag_BG extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        View colorDialogView2 = getActivity().getLayoutInflater().inflate(
                R.layout.fragment_color_dialog_frag__bg, null);
        builder.setView(colorDialogView2); // add GUI to dialog

        // set the AlertDialog's message
        builder.setTitle(R.string.title_color_dialog_bg);

        // get the color SeekBars and set their onChange listeners
        alphaSeekBar = (SeekBar) colorDialogView2.findViewById(
                R.id.alphaSeekBar);
        redSeekBar = (SeekBar) colorDialogView2.findViewById(
                R.id.redSeekBar);
        greenSeekBar = (SeekBar) colorDialogView2.findViewById(
                R.id.greenSeekBar);
        blueSeekBar = (SeekBar) colorDialogView2.findViewById(
                R.id.blueSeekBar);
        colorView = colorDialogView2.findViewById(R.id.colorView);
