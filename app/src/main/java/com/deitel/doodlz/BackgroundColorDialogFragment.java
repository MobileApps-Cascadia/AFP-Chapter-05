...
public class BackgroundColorDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        alphaSeekBar = (SeekBar) backgroundColorDialogView.findViewById(
                R.id.alphaSeekBarBackground);
        redSeekBar = (SeekBar) backgroundColorDialogView.findViewById(
                R.id.redSeekBarBackground);
        greenSeekBar = (SeekBar) backgroundColorDialogView.findViewById(
                R.id.greenSeekBarBackground);
        blueSeekBar = (SeekBar) backgroundColorDialogView.findViewById(
                R.id.blueSeekBarBackground);

        backgroundColorView = backgroundColorDialogView.findViewById(R.id.colorView);

        // register SeekBar event listeners
        alphaSeekBar.setOnSeekBarChangeListener(backgroundColorChangedListener);
        redSeekBar.setOnSeekBarChangeListener(backgroundColorChangedListener);
        greenSeekBar.setOnSeekBarChangeListener(backgroundColorChangedListener);
        blueSeekBar.setOnSeekBarChangeListener(backgroundColorChangedListener);
    ...
    private final SeekBar.OnSeekBarChangeListener backgroundColorChangedListener =
    ...
    protected void draw(Canvas canvas){
        canvas.drawRect(0, 0, 400, 600, backgroundPaint);
    }*/
}
