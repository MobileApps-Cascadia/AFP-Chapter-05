...
// class for the Select Background Color dialog
public class BackgroundColorDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        View bgColorDialogView = getActivity().getLayoutInflater().inflate(
                R.layout.fragment_background_color, null);
        builder.setView(bgColorDialogView); // add GUI to dialog

        // set the AlertDialog's message
        builder.setTitle(R.string.title_background_color_dialog);

        // get the color SeekBars and set their onChange listeners
        alphaSeekBar = (SeekBar) bgColorDialogView.findViewById(
                R.id.alphaSeekBar);
        redSeekBar = (SeekBar) bgColorDialogView.findViewById(
                R.id.redSeekBar);
        greenSeekBar = (SeekBar) bgColorDialogView.findViewById(
                R.id.greenSeekBar);
        blueSeekBar = (SeekBar) bgColorDialogView.findViewById(
                R.id.blueSeekBar);
        colorView = bgColorDialogView.findViewById(R.id.colorView);
